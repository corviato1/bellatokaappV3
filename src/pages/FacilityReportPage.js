...
const FacilityReportPage = () => {
  ...
  const getCompletionStats = () => {
    const completed = facilityTasks.filter(task => isTaskCompleted(task.id)).length;
  ...
  const groupedTasks = {
    'HVAC & Climate Control': facilityTasks.filter(t => t.category === 'hvac'),
    'Cleaning': facilityTasks.filter(t => t.category === 'cleaning'),
    'Pest Prevention': facilityTasks.filter(t => t.category === 'pest-prevention'),
                      ...
                      <div className="task-main">
                        ...
                        <div className="task-info">
                          ...
                          {completed && completionDate && (
                            <span className="completion-date">Completed: {completionDate}</span>
                          )}
                        </div>
                      </div>
